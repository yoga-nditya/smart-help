...
print(get_user(clientid='1bfaswK8zZ', secretekey='JO7Ztf0Fp1VUQRgwWAi1Cr0SJQL3mUu1'))
...
def is_valid_signature_v2(client_key: str, signature_key: str, requesttimestamp: str) -> bool:
    try:
        ...
        return False
print(is_valid_signature_v2(client_key = '1bfaswK8zZ',signature_key='586ec2f7dd4259e2675f4ab78804d1d7419dbeaacda38f9358155900e0ff8922c37a04d8260efca7e118eba0a50adb84136c8e3efd2ba56821dfe6d3fc4e0dc4',requesttimestamp='202506251357'))
